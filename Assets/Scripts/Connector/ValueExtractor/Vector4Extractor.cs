...
{
    [AddComponentMenu("UniFlow/ValueExtractor/Vector4", (int) ConnectorType.ValueExtractorVector4)]
    public class Vector4Extractor : ConnectorBase
    {
        ...
        [ValueReceiver] private Vector4 Value { get; set; }
